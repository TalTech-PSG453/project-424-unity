...
public class Perrinn424CarControllerInspector : VPInspector
	...
	{
		DrawProperty("autoSpeedMode");
		DrawProperty("autoThrotle");
		DrawProperty("outSpeed");
		
		
		DrawProperty("FrontWheelDrive");
		DrawProperty("RearWheelDrive");
		DrawProperty("AllWheelDrive");
